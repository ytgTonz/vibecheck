    ...
    return (
      <div className="mx-auto max-w-4xl px-4 py-8">
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-8 text-center">
          <p className="text-lg font-medium text-zinc-300">{isOwner ? "No venues yet" : "No venues linked"}</p>
          ...
          {isOwner && (
            <Link href="/dashboard/new" className="mt-4 inline-block rounded-lg bg-white px-4 py-2 text-sm font-medium text-zinc-900 transition-colors hover:bg-zinc-200">
              Add venue
            </Link>
          )}
        </div>
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      <div className="mb-6 flex items-center justify-between">
        ...
        {isOwner && (
          <Link href="/dashboard/new" className="rounded-lg bg-white px-4 py-2 text-sm font-medium text-zinc-900 transition-colors hover:bg-zinc-200">
            Add venue
          </Link>
        )}
      </div>
