  ...
  return (
    ...
    >
      <div className="flex flex-col p-6 sm:p-8">
        <div className="mb-4 self-start rounded-full border border-white/15 bg-white/10 px-3 py-1.5">
        ...
        <div className="mt-4 flex items-center gap-4">
          <span className={`inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-sm font-semibold transition-transform duration-300 group-hover:scale-105 ${venue.isLive ? "bg-brand-red text-white" : "bg-white text-zinc-900"}`}>
