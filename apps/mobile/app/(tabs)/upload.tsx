  ...
  return (
    <Pressable
      ...
      className={`mb-4 rounded-[28px] border px-5 py-5 ${
        venue.isLive ? 'border-red-500/30 bg-red-500/10' : 'border-zinc-800 bg-zinc-900'
      }`}
    >
      <View className="flex-row items-start justify-between gap-3">
        ...
        {venue.isLive ? (
          <View className="rounded-full bg-red-500/20 px-2.5 py-1">
      ...
      <View className={`mt-5 self-start rounded-full px-4 py-2 ${
        venue.isLive ? 'bg-zinc-100' : 'bg-red-500'
      }`}>
  ...
  return (
    <SafeAreaView className="flex-1 bg-zinc-950" edges={['top']}>
      ...
      >
        ...
        <View className="mb-6 rounded-[32px] border border-red-500/30 bg-red-500/10 px-5 py-5">
